...
import com.example.primechecker.ui.theme.PrimeCheckerTheme
...
@Composable
fun PrimeChecker(modifier: Modifier = Modifier) {
    ...
    Surface(color = Color.DarkGray) {
        Column(
            ...
            Text(
                text = stringResource(R.string.primeoutput, primeNumberToCheck, isPrime),
